...
const Order = () => {
    ...
    const itemsPrice = cart.products.reduce((a, product) => a + product.price * product.amount, 0);
    ...
    // Placing an order
    const placeOrder = async (city: string, street: string, credit_card: string, delivery_date: string) => {
        const user = JSON.parse(localStorage.getItem('activeUser'));
